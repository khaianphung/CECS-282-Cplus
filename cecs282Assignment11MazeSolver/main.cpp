...
bool mazeSolvingAlgorithmBFS( deque<Point> &deq, char **arr)//,int &curX, int &curY
{
...
void bfs(Point p, char**arr, int ROW, int COL, deque<Point> &deq)
{
 int curX = p.getX();
    int curY = p.getY();
    bool play4 =false;
